...
/* package SAT-Pol-0.1.0.0 */
#define VERSION_SAT_Pol "0.1.0.0"
#define MIN_VERSION_SAT_Pol(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hatt-1.5.0.3 */
#define VERSION_hatt "1.5.0.3"
#define MIN_VERSION_hatt(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  5 || \
...
#define CURRENT_COMPONENT_ID "SAT-Pol-0.1.0.0-CfnMeGgalar5P7rViiH2gc"

#define CURRENT_PACKAGE_KEY "SAT-Pol-0.1.0.0-CfnMeGgalar5P7rViiH2gc"
